		...
		)
		{
			...
			)
			{
				...
				var me 	= this,
					...
					img = jQuery('<img id="lp_ls_img" src="'+img_url+'"  style="cursor:pointer;width:120px;'+(this.grayscale ? '-webkit-filter:grayscale(100%);filter:grayscale(100%);' : '')+'" class="'+(this.blink ? 'lp_blink' : '')+'" />');
