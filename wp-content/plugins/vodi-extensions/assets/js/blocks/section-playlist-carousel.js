...
registerBlockType('vodi/section-playlist-carousel', {
  ...
  edit: props => {
    ...
    const onChangeTabArgsTabPostType = (newTabArgsTabPostType, index) => {
      var tab_args_updated = JSON.parse(tab_args);
    ...
    const onChangeTabArgsShortcodeAtts = (newTabArgsShortcodeAtts, index) => {
      var tab_args_updated = JSON.parse(tab_args);
      tab_args_updated[index].shortcode_atts = { ...tab_args_updated[index].shortcode_atts,
        ...newTabArgsShortcodeAtts
      };
      setAttributes({
        tab_args: JSON.stringify([...tab_args_updated])
      });
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(InspectorControls, null, wp.element.createElement(TextControl, {
      ...
      postType: post_type,
      hideFields: ['columns', 'ids', 'category', 'tag', 'featured', 'top_rated'],
      name: "shortcode_atts",
      valuekey: "attributes",
      attributes: {},
