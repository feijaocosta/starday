...
registerBlockType('vodi/section-live-videos', {
  title: __('Section Live Videos Block', 'vodi-extensions'),
  icon: 'video-alt2',
  ...
  edit: props => {
    ...
    const onChangeSectionTitle = newSectionTitle => {
      setAttributes({
        live_videos_title: newSectionTitle
      });
    };
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(InspectorControls, null, wp.element.createElement(TextControl, {
      label: __('Live Title', 'vodi-extensions'),
