...
registerBlockType('vodi/hot-premieres-block', {
  title: __('Hot Premieres Block', 'vodi-extensions'),
  icon: 'editor-video',
  ...
  edit: props => {
    ...
    const onChangenewHideMovieTitle = newHideMovieTitle => {
      setAttributes({
        hide_movie_title: newHideMovieTitle
      });
    };
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(InspectorControls, null, wp.element.createElement(TextControl, {
      ...
      label: __('Hide Movie Title', 'vodi-extensions'),
      help: __('Check to hide movie title.', 'vodi-extensions'),
