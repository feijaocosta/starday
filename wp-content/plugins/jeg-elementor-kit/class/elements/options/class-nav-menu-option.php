...
class Nav_Menu_Option extends Option_Abstract {
	...
	public function set_element_options() {
		...
		$this->options['sg_menu_direction'] = array(
			...
			'selectors'   => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-nav-menu .jkit-menu-wrapper:not(.active) .jkit-menu, {{WRAPPER}} .jeg-elementor-kit.jkit-nav-menu .jkit-menu-wrapper:not(.active) .jkit-menu > li > a' => 'display: {{VALUE}};',
				),
			),
		);
