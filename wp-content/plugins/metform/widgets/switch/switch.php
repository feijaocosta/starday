...
Class MetForm_Input_Switch extends Widget_Base{
    ...
    protected function render($instance = []){
		...
		$switch_text_enable = isset($mf_swtich_enable_text) ? strtolower($mf_swtich_enable_text) : '';
		$switch_text_disable = isset($mf_swtich_disable_text) ? strtolower($mf_swtich_disable_text) : '';
		...
		<div class="mf-input-wrapper">
			...
			<span class="mf-input-switch-control mf-input-switch">
				<input type="checkbox"
					...
					value="<?php echo \MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_disable), $render_on_editor ); ?>"
					...
					/>
				<label
					data-enable="<?php echo \MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_enable), $render_on_editor ); ?>"
					data-disable="<?php echo \MetForm\Utils\Util::react_entity_support( esc_attr($switch_text_disable), $render_on_editor ); ?>"
