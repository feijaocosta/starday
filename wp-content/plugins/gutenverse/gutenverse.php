...
defined( 'GUTENVERSE_VERSION' ) || define( 'GUTENVERSE_VERSION', '1.2.1' );
...
require_once GUTENVERSE_DIR . 'vendor/autoload.php';
register_wp_autoload( 'Gutenverse', GUTENVERSE_DIR . '/includes' );
Gutenverse::instance();
