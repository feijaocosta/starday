                            ...
                            <div class="attr-modal-body" id="metform_form_modal_body">
                                ...
                                <div class="mf-input-group">
                                    ...
                                    <select name="mf_payment_currency" id="" class="mf_payment_currency attr-form-control">
                                        <?php foreach ($currencies as $key => $value) { ?>
                                            <option value="<?php echo $key ?>" <?php echo $key == 'USD' ? 'selected' : '' ?>><?php echo $value . ' (' . $key . ')' ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <?php if (class_exists('\MetForm_Pro\Core\Integrations\Payment\Paypal')) : ?>
                                    <div class="mf-input-group">
                                        ...
                                        <span class='mf-input-help'><?php esc_html_e('Integrate paypal payment with this form.', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings#mf-payment_options'; ?>"><?php esc_html_e('Configure paypal payment.', 'metform'); ?></a></span>
                                    </div>
                                <?php endif ?>
                                ...
                                <?php if (class_exists('\MetForm_Pro\Core\Integrations\Payment\Stripe')) : ?>
                                    <div class="mf-input-group">
                                        ...
                                        <span class='mf-input-help'><?php esc_html_e('Integrate stripe payment with this form. ', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings#mf-payment_options'; ?>"><?php esc_html_e('Configure stripe payment.', 'metform'); ?></a></span>
                                    </div>
                                <?php endif ?>
                            ...
                            <div class="attr-modal-body" id="metform_form_modal_body">
                                ...
                                <?php if (class_exists('\MetForm_Pro\Core\Integrations\Crm\Helpscout\Helpscout')) : ?>
                                    ...
                                    <div class="mf-input-group">
                                        ...
                                        <span class='mf-input-help'><?php esc_html_e('Integrate Helpscout with this form. ', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings#mf_crm'; ?>"><?php esc_html_e('Configure Helpscout.', 'metform'); ?></a></span>
